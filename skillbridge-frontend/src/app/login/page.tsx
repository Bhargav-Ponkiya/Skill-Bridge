      ...
      <div className="w-full max-w-md surface border rounded-2xl p-8 animate-fade-in">
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-border bg-white text-gray-700 font-semibold hover:bg-gray-50 transition-all shadow-sm disabled:opacity-70"
          >
            {googleLoading ? (
