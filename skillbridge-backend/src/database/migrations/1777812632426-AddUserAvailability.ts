...
export class AddUserAvailability1777812632426 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD "p1Completed" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD "p2Completed" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD "suggestedResources" jsonb`);
        await queryRunner.query(`ALTER TABLE "portfolios" ADD CONSTRAINT "FK_e7d697a2603c9b97612aed95284" FOREIGN KEY ("skillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "portfolios" DROP CONSTRAINT "FK_e7d697a2603c9b97612aed95284"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP COLUMN "suggestedResources"`);
