...
export class InitialMigration1777275583517 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."skills_type_enum" AS ENUM('OFFER', 'WANT')`);
        await queryRunner.query(`CREATE TYPE "public"."skills_proficiencylevel_enum" AS ENUM('BEGINNER', 'INTERMEDIATE', 'EXPERT')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ee1265e76ea0b8c5f7daa85e81" ON "skills" ("userId") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."match_requests_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'DECLINED')`);
        await queryRunner.query(`CREATE TABLE "match_requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fromUserId" uuid NOT NULL, "toUserId" uuid NOT NULL, "offeredSkillId" uuid NOT NULL, "wantedSkillId" uuid NOT NULL, "status" "public"."match_requests_status_enum" NOT NULL DEFAULT 'PENDING', "message" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7349a97326e887defffe4531598" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_21eb1f5ebc3a2323978871d468" ON "match_requests" ("fromUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_df35c53e119d1a85082c78290b" ON "match_requests" ("toUserId") `);
        await queryRunner.query(`CREATE TYPE "public"."sessions_status_enum" AS ENUM('NEGOTIATING', 'SCHEDULED', 'ACTIVE', 'COMPLETED', 'REVIEWED')`);
        await queryRunner.query(`CREATE TYPE "public"."sessions_format_enum" AS ENUM('VIDEO', 'TEXT', 'IN_PERSON')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f9e76f6602bfd77a60e8088a6d" ON "sessions" ("participant1Id") `);
        await queryRunner.query(`CREATE INDEX "IDX_20dbc6a6e2c22c34e4431ac22e" ON "sessions" ("participant2Id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a850a1d2a7c119634df63e8a03" ON "reviews" ("sessionId") `);
        ...
        await queryRunner.query(`ALTER TABLE "match_requests" ADD CONSTRAINT "FK_21eb1f5ebc3a2323978871d4685" FOREIGN KEY ("fromUserId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match_requests" ADD CONSTRAINT "FK_df35c53e119d1a85082c78290b4" FOREIGN KEY ("toUserId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match_requests" ADD CONSTRAINT "FK_66cf951844cbafa15fa2872d2e4" FOREIGN KEY ("offeredSkillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match_requests" ADD CONSTRAINT "FK_30c5feff2277b05480a7e656ba9" FOREIGN KEY ("wantedSkillId") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_8cfad04716b6cf3be8734e4b301" FOREIGN KEY ("matchRequestId") REFERENCES "match_requests"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_f9e76f6602bfd77a60e8088a6d5" FOREIGN KEY ("participant1Id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_20dbc6a6e2c22c34e4431ac22ef" FOREIGN KEY ("participant2Id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_ae45b1143279314bf8924089054" FOREIGN KEY ("skill1Id") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_6fcbd0f84edb242121f1029e7f1" FOREIGN KEY ("skill2Id") REFERENCES "skills"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT "FK_a850a1d2a7c119634df63e8a030"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_6fcbd0f84edb242121f1029e7f1"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_ae45b1143279314bf8924089054"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_20dbc6a6e2c22c34e4431ac22ef"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_f9e76f6602bfd77a60e8088a6d5"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "FK_8cfad04716b6cf3be8734e4b301"`);
        await queryRunner.query(`ALTER TABLE "match_requests" DROP CONSTRAINT "FK_30c5feff2277b05480a7e656ba9"`);
        await queryRunner.query(`ALTER TABLE "match_requests" DROP CONSTRAINT "FK_66cf951844cbafa15fa2872d2e4"`);
        await queryRunner.query(`ALTER TABLE "match_requests" DROP CONSTRAINT "FK_df35c53e119d1a85082c78290b4"`);
        await queryRunner.query(`ALTER TABLE "match_requests" DROP CONSTRAINT "FK_21eb1f5ebc3a2323978871d4685"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c8f626e1e943aabb0f90fb8ee6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f9238c3e3739dc40322f577fc4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a850a1d2a7c119634df63e8a03"`);
        await queryRunner.query(`DROP TABLE "reviews"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_20dbc6a6e2c22c34e4431ac22e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f9e76f6602bfd77a60e8088a6d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_df35c53e119d1a85082c78290b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_21eb1f5ebc3a2323978871d468"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ee1265e76ea0b8c5f7daa85e81"`);
        await queryRunner.query(`DROP TABLE "skills"`);
        await queryRunner.query(`DROP TYPE "public"."skills_proficiencylevel_enum"`);
